 ...
 */
final class Version20250116073836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fruit (id INT NOT NULL, quantity INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
